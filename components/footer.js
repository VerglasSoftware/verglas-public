...
export default function Footer({ children, title }) {
	return (
		<footer className="bg-primary-900 flex flex-col items-center py-6">
			<Image
				src={_logo}
			...
			<div className="grid grid-cols-3 gap-32 text-primary-100 mt-4 mb-8">
			...
			<div className="flex flex-row items-center text-primary-100 mb-4 gap-12">
