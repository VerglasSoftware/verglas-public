...
export default function Press() {
  ...
  return (
    <Layout title="Press centre">
      <div className="h-[35vh] w-screen bg-hero5 bg-center bg-cover relative flex items-center overflow-hidden" id="hero">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="col-span-2 space-y-8">
                ...
                <div className="flex justify-start items-start">
                  <p className="text-xl leading-relaxed font-light">We provide up-to-date information on the company and its events to our followers and the media here via our blog. For more information, you can contact us using the details in the page footer.</p>
                </div>
              </div>
            </div>
