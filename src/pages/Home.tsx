    ...
    <Layout title="Home">
      <div className="h-[75vh] sm:h-[95vh] w-screen bg-hero bg-cover relative overflow-hidden" id="hero">
        ...
        <div className="absolute bottom-20 left-20 text-8xl font-extrabold hidden sm:block z-10">
          <div className="bg-white/95 backdrop-blur-sm px-6 py-4 w-fit rounded-lg shadow-lg">
            <span className="bg-gradient-to-r from-fuchsia-600 to-sky-400 bg-clip-text text-transparent">
              inspiring the
            </span>
          </div>
          <div className="bg-white/95 backdrop-blur-sm px-6 py-4 pb-5 w-fit rounded-lg shadow-lg mt-2">
        ...
        <div className="text-5xl font-extrabold block sm:hidden absolute bottom-20 w-fit z-10">
          <div className="bg-white/95 backdrop-blur-sm px-8 py-4 w-fit rounded-lg shadow-lg mx-4">
      ...
      <div className="w-screen flex items-center justify-center">
        <div className="w-3/4 sm:w-2/3">
          <div id="about" className="py-20">
            ...
            <div className="grid sm:grid-cols-2 gap-16 mt-16 text-neutral-700">
              <div className="space-y-6">
                ...
                <Link to="" className="inline-block font-bold hover:underline text-primary-600 decoration-primary-600 decoration-2 underline-offset-[5px] transition-all duration-200 hover:text-primary-700">Learn more...</Link>
              </div>
              <div className="flex justify-center items-center relative">
                <div className="bg-red-900 w-full sm:w-64 h-56 sm:absolute right-44 top-60 z-10 sm:shadow-xl block sm:hidden xl:block rounded-lg overflow-hidden">
                  <img
                ...
                <div className="bg-blue-900 w-[22rem] h-[26rem] hidden right-0 top-0 xl:absolute sm:block rounded-lg overflow-hidden shadow-xl">
                  <img
      ...
      <div className="w-screen flex items-center justify-center bg-gradient-to-br from-primary-600 to-primary-700 text-primary-100">
        <div className="w-3/4 sm:w-2/3">
          <div id="impact" className="py-16 flex items-center flex-col">
            <span className="font-extrabold text-4xl mb-4">our impact.</span>
            <div className="grid sm:grid-cols-3 mt-12 gap-12">
              <div className="flex flex-col items-center group">
                <span className="text-6xl font-bold mb-2 group-hover:scale-110 transition-transform duration-300">21</span>
                <span className="text-xl font-semibold text-center">secondary schools</span>
              </div>
              <div className="flex flex-col items-center group">
                <span className="text-6xl font-bold mb-2 group-hover:scale-110 transition-transform duration-300">320</span>
                <span className="text-xl font-semibold text-center">students reached</span>
              </div>
              <div className="flex flex-col items-center group">
                <span className="text-6xl font-bold mb-2 group-hover:scale-110 transition-transform duration-300">59</span>
      ...
      <div className="w-screen flex items-center justify-center">
        <div className="w-3/4 sm:w-2/3">
          <div id="committees" className="py-24">
            <div className="grid md:grid-cols-2 gap-16 mt-8 text-neutral-700">
              <div className="group">
                <button 
                  className="hover:bg-primary-50 w-full rounded-xl overflow-hidden shadow-sm hover:shadow-lg transition-all duration-300" 
                ...
                >
                  ...
                  <div className="p-8 flex flex-col items-start">
                    <span className="font-extrabold text-neutral-700 text-4xl mb-4">outreach.</span>
                    <p className="text-start mb-6 text-lg leading-relaxed">
                    ...
                    <Link to="/outreach" className="font-bold hover:underline text-primary-600 decoration-primary-600 decoration-2 underline-offset-[5px] transition-colors hover:text-primary-700">Learn more...</Link>
                  </div>
                </button>
              </div>
              <div className="group">
                ...
                >
                  ...
                  <div className="p-8 flex flex-col items-start">
                    <span className="font-extrabold text-neutral-700 text-4xl mb-4">software.</span>
                    <p className="text-start mb-6 text-lg leading-relaxed">
                    ...
                    <Link to="/products" className="font-bold hover:underline text-primary-600 decoration-primary-600 decoration-2 underline-offset-[5px] transition-colors hover:text-primary-700">Learn more...</Link>
                  </div>
                </button>
              </div>
            </div>
      ...
      <div className="w-screen flex items-center justify-center">
        <div className="w-3/4 sm:w-2/3">
          <div id="news" className="py-24">
            ...
            <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-8 mt-12 text-neutral-700">
              {allPostsData.map(post => (
                ...
                >
                  ...
                  <div className="relative z-10 px-4 py-5 flex flex-col items-start justify-end h-48 text-white">
