...
export default function Home() {
  ...
  return (
    <Layout title="Home">
      <div
        className="h-[75vh] sm:h-[95vh] w-screen bg-hero bg-cover relative overflow-hidden"
        id="hero"
      >
      ...
      <div className="w-screen flex items-center justify-center bg-gradient-to-b from-neutral-50 to-white">
        <div className="w-3/4 sm:w-2/3">
          <div id="about" className="py-24">
            <span className="font-extrabold text-neutral-700 text-5xl leading-tight">
              hey. we're verglas.
            </span>
            <div className="grid sm:grid-cols-2 gap-20 mt-20 text-neutral-700">
              <div className="space-y-8">
                <p className="text-xl leading-relaxed font-light">
                  We're a new startup based in Northern Ireland, developing
                  software solutions to add competitive edge to the classroom
                  and promote technology and programming to the next generation
                  of IT enthusiasts. We want to make it easier for teachers to
                  teach and test their students, while receiving detailed
                  feedback and analytics to evaluate their lessons.
                </p>
                <p className="text-xl leading-relaxed font-light">
                  We were founded by a group of 17-18 year old students from
                  Northern Ireland and England, with the help of the biggest
                  software companies in the country. We're on a mission to
                  inspire students - giving them the same opportunities to get
                  into the industry and make likeminded friends that we were
                  given.
                </p>
                <p className="text-xl leading-relaxed font-light">
                  We're most well known for organizing the annual IglooCode
                  programming competition for 13-15 year olds at Queen's
                  University Belfast, in partnership with Kainos and Liberty IT.
                  Our last event in Belfast welcomed over 100 aspiring
                  programmers from 16 schools across the country.
                </p>
                <Link
                  to=""
                  className="inline-block font-bold hover:underline text-primary-600 decoration-primary-600 decoration-2 underline-offset-[5px] transition-all duration-200 hover:text-primary-700 text-lg"
                >
                  Learn more...
                </Link>
              </div>
              ...
              <div className="group">
                ...
                >
                  ...
                  <div className="p-10 flex flex-col items-start">
                    <span className="font-extrabold text-neutral-700 text-4xl mb-6">
                      outreach.
                    </span>
                    <p className="text-start mb-8 text-xl leading-relaxed font-light">
                      Here at Verglas, we have a huge committment to outreach.
                      We run multiple programmes across Northern Ireland, with
                      more in the planning phase, which are available to
                      computing students from the UK. We also work directly with
                      local secondary schools to organize invite-only events for
                      their pupils, such as our biggest event, IglooCode, which
                      last year welcomed over 100 aspiring programmers from
                      County Antrim.
                    </p>
                    <Link
                      to="/outreach"
              ...
              <div className="group">
                ...
                >
                  ...
                  <div className="p-10 flex flex-col items-start">
                    ...
                    <p className="text-start mb-8 text-xl leading-relaxed font-light">
                      As students ourselves, we understand that learning can be
                      boring. We want to give teachers the opportunity to give
                      their classes an excited buzz, providing them with
                      solutions to engage and consolidate their students'
                      learning, and in return give them detailed analytics to
                      review how much knowledge is actually being retained. We
                      work from local teachers from NI to develop platforms that
                      really work for you.
                    </p>
                    <Link
                      to="/products"
      ...
      <div className="w-screen flex items-center justify-center bg-gradient-to-br from-primary-600 via-primary-700 to-primary-800 text-primary-100">
        <div className="w-3/4 sm:w-2/3">
          <div id="partners" className="py-20 flex items-center flex-col">
            <span className="font-extrabold text-5xl sm:text-start text-center mb-8">
              who we've worked with.
            </span>
            <Marquee
              pauseOnHover={false}
              className="mt-8 border-y border-primary-400/30 py-8"
            >
              <div className="flex items-center space-x-16 py-6 mx-8">
                <div className="flex-shrink-0">
                  <div className="w-28 h-28 relative">
                    <img
                      src={getImagePath(
                        "images/partnersandschools/credit-logo.png"
                      )}
                      alt="Partner"
                ...
                <div className="flex-shrink-0">
                  <div className="w-56 h-28 relative">
                    <img
                      src={getImagePath(
                        "images/partnersandschools/LIT-footer-logo.png.avif"
                      )}
                      alt="Liberty IT"
                      className="w-full h-full object-contain opacity-80 hover:opacity-100 transition-opacity duration-300"
                    />
                ...
                <div className="flex-shrink-0">
                  <div className="w-56 h-28 relative">
                    <img
                      src={getImagePath(
                        "images/partnersandschools/kainos_transparent-2.webp"
                      )}
                      alt="Kainos"
                      className="w-full h-full object-contain opacity-80 hover:opacity-100 transition-opacity duration-300"
                    />
                ...
                <div className="flex-shrink-0">
                  <div className="w-40 h-28 relative">
                    <img
                      src={getImagePath(
                        "images/partnersandschools/New-New-Bridge-Logo-Final-no-background-1024x1024.png"
                      )}
                ...
                <div className="flex-shrink-0">
                  <div className="w-28 h-28 relative">
                    <img
                      src={getImagePath(
                        "images/partnersandschools/RBAI-Crest-RGB.webp"
                      )}
                ...
                <div className="flex-shrink-0">
                  <div className="w-48 h-28 relative">
                    <img
                      src={getImagePath(
                        "images/partnersandschools/St Dominics_Without For Girls_Black(1).avif"
                      )}
                ...
                <div className="flex-shrink-0">
                  <div className="w-40 h-28 relative">
                    <img
                      src={getImagePath(
                        "images/partnersandschools/campbell.svg"
                      )}
                ...
                <div className="flex-shrink-0">
                  <div className="w-40 h-28 relative">
                    <img
                      src={getImagePath(
                        "images/partnersandschools/methodist.svg"
                      )}
                ...
                <div className="flex-shrink-0">
                  <div className="w-40 h-28 relative">
                    <img
                      src={getImagePath(
                        "images/partnersandschools/strathern.png"
                      )}
                ...
                <div className="flex-shrink-0">
                  <div className="w-56 h-28 relative">
                    <img
                      src={getImagePath(
                        "images/partnersandschools/Filetoupload,967358,en-2.png"
                      )}
                      alt="Partner"
                      className="w-full h-full object-contain opacity-80 hover:opacity-100 transition-opacity duration-300"
                    />
      ...
      <div className="w-screen flex items-center justify-center bg-gradient-to-b from-neutral-50 to-white">
        <div className="w-3/4 sm:w-2/3">
          <div id="news" className="py-28">
            <span className="font-extrabold text-neutral-700 text-4xl mb-4">
              verglas news & press releases.
            </span>
