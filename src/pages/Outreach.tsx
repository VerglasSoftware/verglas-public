...
export default function Outreach() {
  return (
    <Layout title="Outreach">
      <div
        className="h-[45vh] w-screen bg-hero2 bg-center bg-cover relative overflow-hidden"
        id="hero"
      >
        ...
        <div className="w-3/4 sm:w-1/2">
          <div id="about" className="py-28 grid sm:grid-cols-2 gap-16">
            <div className="flex justify-start items-start">
              <span className="font-bold text-neutral-700 text-4xl leading-tight">
                captivating the next generation of tech.
              </span>
            </div>
            <div className="flex justify-center items-center">
              <p className="text-xl leading-relaxed font-light">
                Our outreach programmes are designed to inspire and educate
                young people about technology and programming. Through hands-on
                workshops, competitions, and partnerships with schools, we aim
                to build the next generation of tech talent in Northern Ireland
                and beyond.
              </p>
            </div>
          </div>
      ...
      <div className="w-screen flex items-center justify-center bg-white">
        <div className="w-3/4 sm:w-1/2">
          <div className="py-28">
            <h2 className="font-bold text-neutral-700 text-4xl mb-16">
              IglooCode Competition
            </h2>
            <div className="grid sm:grid-cols-2 gap-20">
              ...
              <div className="space-y-8">
                <p className="text-xl leading-relaxed font-light">
                  IglooCode is our flagship programming competition for
                  secondary school students aged 13-15. The competition combines
                  creative problem-solving with technical challenges,
                  encouraging students to work in teams while developing their
                  coding skills.
                </p>
                <p className="text-xl leading-relaxed font-light">
                  Our most recent event at Queen's University Belfast welcomed
                  over 100 students from 16 schools across Northern Ireland,
                  with partnerships from major tech companies including Kainos
                  and Liberty IT.
                </p>
                <a
            ...
            <div className="grid sm:grid-cols-2 gap-20">
              <div className="text-center space-y-8">
                ...
                <p className="leading-relaxed text-lg font-light">
                  We work directly with secondary schools to organize computing
                  workshops and competitions. Contact us to bring our outreach
                  programmes to your school.
                </p>
                <a
                  href="mailto:outreach@verglas.io"
                  className="inline-block font-bold hover:underline text-primary-100 decoration-primary-100 decoration-2 underline-offset-[5px] transition-colors hover:text-white text-lg"
                >
              ...
              <div className="text-center space-y-8">
                ...
                <p className="leading-relaxed text-lg font-light">
                  Interested in participating in our competitions or joining our
                  community? Follow us on social media and sign up for updates
