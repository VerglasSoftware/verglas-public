...
- Visit our website at educa.tr, or any website of ours that links to this privacy notice
...
**Questions or concerns?** Reading this privacy notice will help you understand your privacy rights and choices. If you do not agree with our policies and practices, please do not use our Services. If you still have any questions or concerns, please contact us at dana@verglas.io.
...
IglooCode started as a day out to meet our friend Emma's Code Club at Strathearn School in Belfast, but later developed into the county-wide event that took place in March. Emma, Aideen and I met during the 2022 CyberFirst Advanced course in Queen's University, where we made loads of new friends who we're still very close with today – most of the IglooCode staff team this year were also on the course.

Working alongside my friend Jake to put together the capture-the-flag software was one of the first times I have ever collaborated with someone else on a development project. I had the challenge of figuring out how Git pull requests and code reviews worked, not to mention the couple hundred times we had to fix merge conflicts.
